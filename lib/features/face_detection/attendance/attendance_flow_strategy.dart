...
class AttendanceFlowStrategy implements CaptureFlowStrategy {
  AttendanceFlowStrategy({this.holdDuration = const Duration(milliseconds: 1500)});
  ...
  (FaceCaptureStep, bool) onCaptureSuccess({
    ...
    // Single-shot front capture per attendance cycle.
